...
function NavbarHamburguer() {
  ...
  return (
      <div className='navbarHamburguer'>
        ...
        <a  href='https://www.google.com/' target='_blank' ><img className='navbarHamburguer-Logo'  src= {Github} /></a>
         <a  href='https://www.google.com/' target='_blank' ><img className='navbarHamburguer-Logo'  src= {Educamas} /></a>
         </div>
